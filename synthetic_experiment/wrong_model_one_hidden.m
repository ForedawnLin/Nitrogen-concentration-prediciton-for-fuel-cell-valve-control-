...
A=1;B=2;C=3;D=4;E=5;F=6;K=11;  %%% observed variable 
G=7;H=8;I=9;J=10;L=12;M=13; %%% hidden units 
...
bnet.CPD{L}=gaussian_CPD(bnet,L,'mean',[0.5],'cov',[0.01]);
bnet.CPD{M}=gaussian_CPD(bnet,M,'mean',[0.5],'cov',[0.01]);
