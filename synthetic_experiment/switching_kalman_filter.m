...
ns=[2 1 1]; 
dnodes=[1];  
bnet=mk_dbn(intra,inter,ns,'discrete',dnodes,'observed',[3],'eclass1',eclass1,'eclass2',eclass2); 
...
bnet.CPD{1}=tabular_CPD(bnet,1,'CPT',[0.5 0.8]);
bnet.CPD{2}=gaussian_CPD(bnet,2,'cov_type','diag');
bnet.CPD{3}=gaussian_CPD(bnet,3,'cov_type','diag');
bnet.CPD{4}=tabular_CPD(bnet,4,'CPT',[0.5 0.2 0.5 0.8]);
...
bnet.CPD{5}=gaussian_CPD(bnet,5,'cov_type','diag');
