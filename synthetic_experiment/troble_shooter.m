...
% bnet.CPD{1}=tabular_CPD(bnet,1,'CPT',[0.5 0.5]); 
%bnet.CPD{2}=tabular_CPD(bnet,3,'CPT',[0.5 0.5]); 
bnet.CPD{1}=gaussian_CPD(bnet,1,'mean',[0],'cov',[0.01],'cov_type','diag');
%bnet.CPD{1}=root_CPD(bnet,1);
bnet.CPD{2}=gaussian_CPD(bnet,2,'mean',[3],'cov_type','diag');
bnet.CPD{3}=gaussian_CPD(bnet,4,'mean',[1],'cov_type','diag');
